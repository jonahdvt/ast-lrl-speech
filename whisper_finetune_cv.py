...
def load_commonvoice_stream(lang, split="validated", max_samples=650):
...
def load_fleurs_stream(lang="lg_ug", split="train", max_samples=None):
    ds = load_dataset(
        "google/fleurs",
        name=lang,
        split=split,
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./whisper-large-lg-1h",
...
trainer.push_to_hub(
    ...
    language=cv_lang,
    model_name="Whisper Large — Luganda (1h)",
...
processor.push_to_hub("jonahdvt/whisper-large-lg-1h")