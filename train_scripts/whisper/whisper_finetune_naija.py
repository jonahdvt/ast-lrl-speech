...
nv_lang_batch = "yoruba-batch-0"     # NaijaVoices Igbo
max_nv_samples = 2525              # or whatever you prefer
fleurs_lang = "yo_ng"              # FLEURS Igbo
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./whisper-large-yo-2.5h",
...
processor.push_to_hub("jonahdvt/whisper-large-yo-2.5h")
